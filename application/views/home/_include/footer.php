<footer class="site__footer">
    <div class="site-footer">
                ...
                <div class="row">
                                ...
                                <table class="table table-borderless table-sm">
                                    <tr>
                                        <td style="width: 20px"><i
                                                class="footer-contacts__icon fas fa-globe-americas"></i></td>
                                        <td><?= $iden['alamat'] ?> <br>
                                            <?= $kota['nama_kota'] ?>
                                        </td>
                                    </tr>
                    ...
                    <div class="col-12 col-md-12 col-lg-4">
                        <!-- <div class="site-footer__widget footer-newsletter">
                            ...
                            <div class="footer-newsletter__text">Berlangganan sekarang, dan dapatkan informasi terbaru
                                dari kami.</div>
                            <form action="<?= base_url('subscribe') ?>" method="POST" class="footer-newsletter__form">
                                ...
                                <input name="email" type="text" class="footer-newsletter__form-input form-control"
                                    id="footer-newsletter-address" placeholder="Alamat Email...">
                                <button name="submit" type="submit"
                                    class="footer-newsletter__form-button btn btn-primary">Subscribe</button>
                            </form> -->
                        <div class="footer-newsletter__text footer-newsletter__text--social">Ikuti kami dimedia
                            sosial</div>
                        <ul class="footer-newsletter__social-links">
                            <li class="footer-newsletter__social-link footer-newsletter__social-link--facebook">
                                <a href="<?= $iden['facebook'] ?>" target="_blank"><i class="fab fa-whatsapp"></i></a>                              
                            <li class="footer-newsletter__social-link footer-newsletter__social-link--instagram">
                                <a href="<?= $iden['instagram'] ?>" target="_blank"><i class="fab fa-instagram"></i></a>
                            </li>
                        </ul>
                    </div>
                </div>
        ...
        <div class="site-footer__bottom">
            <div class="site-footer__copyright">&copy; <?= date('Y') ?> <a href="https://zamanet.com/"
                    target="_BLANK">Yourvapestore</a></div>
        </div>
    </div>
    ...
    <div class="totop">
        <div class="totop__body">
            ...
            <div class="totop__end"><button type="button" class="totop__button"><svg width="13px" height="8px">
                        <use
                            xlink:href="<?= base_url('assets/template/tema/') ?>images/sprite.svg#arrow-rounded-up-13x8">
                        </use>
                    </svg></button></div>
        </div>
    </div>
